...
export default function Home() {
  ...
  return (
    <div className="bg-white dark:bg-zinc-950" style={{ fontFamily: "'Sarabun', sans-serif" }}>

      {/* Hero Section */}
      <div style={{ backgroundColor: '#C65A2E' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center">
            ...
            <p className="mt-4 text-base font-bold uppercase tracking-widest" style={{ color: '#F2E9DF', opacity: 0.7 }}>
              Fueling Cleveland's Creative Workforce Through Collaboration
            </p>

            <p className="mt-6 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed" style={{ color: '#F2E9DF', opacity: 0.9 }}>
              A trust-first platform for artists, community organizations, and foundations to tokenize
              real-world assets on Algorand — transparently, compliantly, and built for the people doing the work.
            </p>
              ...
              <Link
                ...
                style={
                  activeAddress
                    ...
                    : { backgroundColor: '#222222', color: '#F2E9DF', opacity: 0.4, cursor: 'not-allowed', pointerEvents: 'none' }
                }
              >
                Start Tokenizing
              </Link>
      ...
      <div style={{ backgroundColor: '#F2E9DF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="flex items-end justify-between gap-6 mb-10">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs font-bold uppercase tracking-wide" style={{ color: '#C65A2E' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div
                ...
                style={{ backgroundColor: '#FFFFFF', border: '1px solid #e0d9d0' }}
              >
                ...
                <div className="mt-4 flex items-center justify-between text-xs font-semibold" style={{ color: '#C65A2E' }}>
                ...
                {[
                  ...
                  <li key={f.label} className="flex gap-3">
                    ...
                    <span style={{ color: '#F2E9DF' }}>
                      ...
                      <span style={{ opacity: 0.75 }}>{f.desc}</span>
                    </span>
                  </li>
                ))}
              </ul>
            ...
            <div className="rounded-2xl p-8" style={{ backgroundColor: '#C65A2E' }}>
              <div className="rounded-xl p-6 shadow-sm" style={{ backgroundColor: '#F2E9DF', border: '1px solid #e0d9d0' }}>
                ...
                <div className="space-y-3 text-sm">
                  {[
                    { label: 'Asset Name', value: 'Community Arts Fund', valueColor: '#222222' },
                    { label: 'Symbol', value: 'SOUL216', valueColor: '#C65A2E' },
                    { label: 'Total Supply', value: '1,000,000', valueColor: '#222222' },
                    { label: 'Decimals', value: '2', valueColor: '#222222' },
                    { label: 'Manager', value: 'Your Wallet', valueColor: '#222222' },
                  ].map((row, i, arr) => (
                    <div key={row.label}>
          ...
          <Link
            ...
            style={
              activeAddress
                ...
                : { backgroundColor: '#C65A2E', color: '#FFFFFF', opacity: 0.4, cursor: 'not-allowed', pointerEvents: 'none' }
            }
          >
